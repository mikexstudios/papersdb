...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paper.user'
        db.add_column('papers_paper', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paper.user'
        db.delete_column('papers_paper', 'user_id')
