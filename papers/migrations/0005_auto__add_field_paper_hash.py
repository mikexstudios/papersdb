...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paper.hash'
        db.add_column('papers_paper', 'hash', self.gf('django.db.models.fields.CharField')(default='', max_length=32, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paper.hash'
        db.delete_column('papers_paper', 'hash')
