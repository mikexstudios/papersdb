...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paper.updated'
        db.add_column('papers_paper', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 2, 19), blank=True), keep_default=False)

        # Adding field 'Paper.created'
        db.add_column('papers_paper', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 2, 19), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paper.updated'
        db.delete_column('papers_paper', 'updated')

        # Deleting field 'Paper.created'
        db.delete_column('papers_paper', 'created')
