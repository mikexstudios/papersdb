...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Crocodoc'
        db.create_table('papers_crocodoc', (
            ('paper', self.gf('annoying.fields.AutoOneToOneField')(to=orm['papers.Paper'], unique=True, primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('short_id', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
        ))
        db.send_create_signal('papers', ['Crocodoc'])


    def backwards(self, orm):
        
        # Deleting model 'Crocodoc'
        db.delete_table('papers_crocodoc')
    ...
    models = {
        ...
        'papers.crocodoc': {
            ...
            'short_id': ('django.db.models.fields.CharField', [], {'max_length': '6', 'blank': 'True'}),
