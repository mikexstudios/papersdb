...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('papers_userprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('paper_increment', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
        ))
        db.send_create_signal('papers', ['UserProfile'])

        # Adding field 'Paper.local_id'
        db.add_column('papers_paper', 'local_id', self.gf('django.db.models.fields.IntegerField')(default=1, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('papers_userprofile')

        # Deleting field 'Paper.local_id'
        db.delete_column('papers_paper', 'local_id')
