...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paper.has_thumbnail'
        db.add_column('papers_paper', 'has_thumbnail', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paper.has_thumbnail'
        db.delete_column('papers_paper', 'has_thumbnail')
