...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Crocodoc.session_id'
        db.add_column('papers_crocodoc', 'session_id', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Crocodoc.session_id'
        db.delete_column('papers_crocodoc', 'session_id')
